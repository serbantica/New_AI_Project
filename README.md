...
```bash
# Option 1: Use the demo script (recommended for first time)
...
### 📖 Documentation
- **[STREAMLIT_README.md](STREAMLIT_README.md)** - Complete charter tool documentation
- **[example_usage.py](example_usage.py)** - Usage examples and integration guide
